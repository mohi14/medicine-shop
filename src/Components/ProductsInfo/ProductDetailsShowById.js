                  ...
                  <div className="col-md-6">
                    <div className="modal-product-info shop-details-info pl-0">
                      ...
                      <div className="ltn__safe-checkout">
                        ...
                        <img
                          src="https://tunatheme.com/tf/html/vicodin-preview/vicodin/img/icons/payment-2.png"
                          alt="Payment Image"
                        />
                      </div>
                    </div>
            ...
            <div className="col-lg-4">
              <aside className="sidebar ltn__shop-sidebar ltn__right-sidebar">
                ...
                <div className="widget ltn__top-rated-product-widget">
                  ...
                  <ul>
                    {leatestProducts.slice(0, 3).map((leatestProductSingle) => (
                      <li>
                        <div className="top-rated-product-item clearfix">
                          <div className="top-rated-product-img">
                            ...
                            >
                              <img
                                src={leatestProductSingle.imageUrl}
                                alt="#"
                              />
                            </NavLink>
                          </div>
                          <div className="top-rated-product-info">
                            ...
                            <h6>
                              <a
                                href={`/ProductDetails/${leatestProductSingle?.productID}`}
                              >
                            ...
                            <div className="product-price">
                              ...
                              <del>
                                {leatestProductSingle.productPreviousPrice}
                              </del>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="ltn__product-item ltn__product-item-3 text-center">
                    <div className="product-img">
                      <NavLink
                        to={`/ProductDetails/${leatestProductSingle?.productID}`}
                      >
                        <img src={leatestProductSingle.imageUrl} alt="#" />
                      </NavLink>
