        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-4">
                    <div className="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div className="ltn__contact-address-icon">
                            <img src="https://tunatheme.com/tf/html/vicodin-preview/vicodin/img/icons/10.png" alt="Icon Image"/>
                        </div>
                        <h3>Email Address</h3>
                ...
                <div className="col-lg-4">
                    <div className="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div className="ltn__contact-address-icon">
                            <img src="https://tunatheme.com/tf/html/vicodin-preview/vicodin/img/icons/11.png" alt="Icon Image"/>
                        </div>
                        <h3>Phone Number</h3>
                ...
                <div className="col-lg-4">
                    <div className="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div className="ltn__contact-address-icon">
                            <img src="https://tunatheme.com/tf/html/vicodin-preview/vicodin/img/icons/12.png" alt="Icon Image"/>
                        </div>
